...
const translations: Record<Language, TranslationKeys> = {
  en: {
    ...
    dashboard: {
      ...
      quickActionsSubtitle: "Schedule a game, open groups, Ask Kvitt, or settlements.",
  ...
  es: {
    ...
    dashboard: {
      ...
      quickActionsSubtitle: "Programar partida, grupos, Pregunta a Kvitt o liquidaciones.",
  ...
  fr: {
    ...
    dashboard: {
      ...
      quickActionsSubtitle: "Planifier une partie, groupes, Demandez à Kvitt ou règlements.",
  ...
  de: {
    ...
    dashboard: {
      ...
      quickActionsSubtitle: "Spiel planen, Gruppen, Frag Kvitt oder Abrechnungen.",
  ...
  hi: {
    ...
    dashboard: {
      ...
      quickActionsSubtitle: "गेम शेड्यूल, समूह, Kvitt से पूछें या निपटान।",
  ...
  pt: {
    ...
    dashboard: {
      ...
      quickActionsSubtitle: "Agendar jogo, grupos, Pergunte ao Kvitt ou acertos.",
  ...
  zh: {
    ...
    dashboard: {
      ...
      quickActionsSubtitle: "安排牌局、群组、询问 Kvitt 或结算。",
      noGames: "暂无游戏",
      viewAll: "查看全部",
      totalGames: "总游戏数",
      netProfit: "净利润",
